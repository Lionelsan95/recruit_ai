...
def clean_linkedin_json_data(data):
    ...
    cleaned_data = {k: v for k, v in data.items() if v not in empty_values and k not in exclude_keys}
...
if __name__ == "__main__":
    print(
        scrape_linkedin_profile(linkedin_profile_url='https://www.linkedin.com/in/skalskip92/', mock=True),        
    )